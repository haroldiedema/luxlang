...
const tests = [
    {
        ...
        code: [
            ...
            '00000001 DUP                                             // (1:1)',
            '00000002 STORE        [\"x\"]                              // (1:1)',
            '00000003 POP                                             // (1:1)',
            '00000004 CONST        2                                  // (2:1)',
            '00000005 DUP                                             // (2:1)',
            '00000006 STORE        [\"y\"]                              // (2:1)',
            '00000007 POP                                             // (2:1)',
            '00000008 LOAD         \"x\"                                // (3:7)',
            '00000009 LOAD         \"y\"                                // (3:11)',
            '00000010 ADD                                             // (3:11)',
            '00000011 CALL         {name: \"print\", addr: , args: 1}   // (3:11)',
        ],
    },
    {
        ...
        code: [
            '00000000 JMP          7                                                   // (1:1)',
            '00000001 STORE        ["b"]                             ; DECL add(a, b)  // (1:1)',
            '00000002 STORE        ["a"]                                               // (1:1)',
            ...
            '00000010 DUP                                                              // (4:1)',
            '00000011 STORE        [\"result\"]                                          // (4:1)',
            '00000012 POP                                                              // (4:1)',
            '00000013 LOAD         \"result\"                                            // (5:7)',
            '00000014 CALL         {name: \"print\", addr: , args: 1}                    // (5:7)',
            '00000015 POP                                                              // (5:7)',
        ],
    },
    {
    ...
    },
    {
        ...
        code: [
            '00000000 JMP          18                                                          // (1:1)',
            '00000001 STORE        ["n"]                                  ; DECL factorial(n)  // (1:1)',
            '00000002 LOAD         "n"                                                         // (2:8)',
